...
router.delete('/delete/:id', auth('Company_HR'), errorHandle(companyController.deleteCompany));
router.get('/:id', auth('Company_HR'), errorHandle(companyController.getCompanyData));
